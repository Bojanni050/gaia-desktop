...
export const LANGUAGES = {
  nl: {
    ...
    settingsMcp: 'MCP-toolservers',
    settingsMcpHint: 'Lokale tool­servers (MCP, stdio) die Gaia technisch kan aanroepen. Wat een tool betekent, beslist Gaia Cloud — de desktop biedt alleen de uitvoering.',
    settingsMcpEmpty: 'Nog geen toolservers geconfigureerd.',
    settingsMcpAdd: 'Toolserver toevoegen',
    settingsMcpRemove: 'Verwijderen',
    settingsMcpCommand: 'Startopdracht',
    settingsMcpArgs: 'Argumenten (spatie-gescheiden)',
    settingsMcpTools: 'Tools tonen',
    settingsMcpToolsLoading: 'Laden…',
    settingsMcpToolsFailed: 'Tools konden niet worden opgehaald.',
    ...
    // Update panel
    updateTitle: 'Updates',
    updateHint: 'Controleren op updates...',
    updateChecking: 'Controleren op updates...',
    updateAvailable: 'Update beschikbaar',
    updateDescription: 'Een nieuwe versie is klaar om te installeren.',
    updateVersion: 'Versie',
    updateInstall: 'Update installeren',
    updateInstalling: 'Update aan het installeren...',
    updateDownloaded: 'Update succesvol gedownload!',
    updateRestartHint: 'De applicatie moet herstarten om de update te voltooien.',
    updateRestart: 'Nu herstarten',
    updateNotAvailable: 'Je hebt de nieuwste versie.',
    updateCheckAgain: 'Nogmaals controleren',
    updateError: 'Update controle mislukt',
    updateRetry: 'Opnieuw proberen',
    updateSettings: 'Updates',
    updateCheckForUpdates: 'Controleren op updates',
  },
  en: {
    ...
    settingsMcp: 'MCP tool servers',
    settingsMcpHint: 'Local tool servers (MCP, stdio) Gaia can technically invoke. What a tool means is decided by Gaia Cloud — the desktop only provides execution.',
    settingsMcpEmpty: 'No tool servers configured yet.',
    settingsMcpAdd: 'Add tool server',
    settingsMcpRemove: 'Remove',
    settingsMcpCommand: 'Launch command',
    settingsMcpArgs: 'Arguments (space-separated)',
    settingsMcpTools: 'Show tools',
    settingsMcpToolsLoading: 'Loading…',
    settingsMcpToolsFailed: 'Could not fetch tools.',
    settingsSave: 'Save',
    ...
    updateRestartHint: 'The application needs to restart to complete the update.',
    ...
    updateSettings: 'Updates',
    updateCheckForUpdates: 'Check for Updates',
  },
};
